...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(
		...
		React.createElement(
			...
			React.createElement(_reactRouter.IndexRoute, { component: _components.MainContent }),
			...
			React.createElement(_reactRouter.Route, { path: '/createResume', component: _components.CreateResume }),
			React.createElement(_reactRouter.Route, { path: '*', component: _components.MainContent })
		)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainContact = __webpack_require__(213);
	
	var _mainContact2 = _interopRequireDefault(_mainContact);
	
	var _main3 = __webpack_require__(214);
	
	var _main4 = _interopRequireDefault(_main3);
	
	var _mainTip = __webpack_require__(215);
	
	var _mainTip2 = _interopRequireDefault(_mainTip);
	
	var _mainTips = __webpack_require__(216);
	
	var _mainTips2 = _interopRequireDefault(_mainTips);
	...
	var _userMain = __webpack_require__(219);
	
	var _userMain2 = _interopRequireDefault(_userMain);
	
	var _description = __webpack_require__(220);
	
	var _description2 = _interopRequireDefault(_description);
	
	var _descriptionItem = __webpack_require__(221);
	
	var _descriptionItem2 = _interopRequireDefault(_descriptionItem);
	
	var _resume = __webpack_require__(222);
	
	var _resume2 = _interopRequireDefault(_resume);
	
	var _resumes = __webpack_require__(223);
	...
	exports.EmployerContact = _mainContact2.default;
	exports.MainContent = _main4.default;
	exports.MainTip = _mainTip2.default;
	exports.MainTips = _mainTips2.default;
	exports.Counter = _counter2.default;
	exports.Home = _home2.default;
	exports.UserMain = _userMain2.default;
	...
	exports.CreateResume = _createResume2.default;
	exports.UserMainResume = _userMainResume2.default;
	exports.WorkerMain = _workerMain2.default;
	...
	var Header = function (_React$Component) {
	  ...
	  _createClass(Header, [{
	    ...
	    value: function logOut() {
	      ...
	      (0, _utils.ajax)('/logout', '', function (data) {
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement('span', { className: 'icon icon-bar' }),
	              React.createElement('span', { className: 'icon icon-bar' }),
	              React.createElement('span', { className: 'icon icon-bar' })
	            ),
	            React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'ul',
	              { className: 'nav navbar-nav navbar-right main-navigation' },
	              window.localStorage['id'] ? React.createElement(
	                'li',
	                null,
	                React.createElement(
	                  _reactRouter.Link,
	                  { to: window.localStorage['worker'] ? '/worker/' : '/user/' },
	                  'PROFILE'
	                )
	              ) : null,
	              React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.scrollToElement = exports.ajax = undefined;
	
	var _ajax2 = __webpack_require__(209);
	
	var _ajax3 = _interopRequireDefault(_ajax2);
	
	var _scrollToElement2 = __webpack_require__(210);
	
	var _scrollToElement3 = _interopRequireDefault(_scrollToElement2);
	...
	exports.scrollToElement = _scrollToElement3.default;
...
/***/ function(module, exports) {
	...
	exports.default = function (url, data, func) {
	  ...
	  request.onload = function () {
	    ...
	    console.log('Response: by ' + url, response, request.status);
	...
	function scrollToElement(id) {
	  ...
	  var move = setInterval(function () {
	    ...
	    if (keyCounter >= nextScroll / 2 && key > 0 || keyCounter <= nextScroll / 2 && key < 0) {
	      (function () {
	        clearInterval(move);
	        var moveSlower = setInterval(function () {
	          key -= nextScroll > 0 ? 1 : -1;
	          document.body.scrollTop += key;
	          if (key === 0) {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              "div",
	              { className: "col-md-6 col-sm-6 wow fadeInUp", "data-wow-delay": "0.3s" },
	              React.createElement(
	                "h2",
	                null,
	                "Worker && Employer"
	              ...
	              React.createElement(
	                "p",
	                null,
	                "Our work is find your work!"
	              ),
	              React.createElement(
	                "p",
	                null,
	                "Copyright © 2016 Worker && Employer | Design: ",
	                React.createElement(
	                  "a",
	                  { rel: "nofollow", href: "", target: "_parent" },
	                  "Busygin Dmitry"
	                )
	              )
	            ),
	            React.createElement(
	              "div",
	              { className: "link-list col-md-2 col-sm-2 wow fadeInUp", "data-wow-delay": "0.3s" },
	              React.createElement(
	                "h2",
	                null,
	                "Company"
	            ...
	            React.createElement(
	              "div",
	              { className: "col-md-2 col-sm-2 wow fadeInUp", "data-wow-delay": "0.3s" },
	              React.createElement(
	                "h2",
	                null,
	                "Network"
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  "li",
	                  null,
	                  React.createElement("a", { href: "https://facebook.com", className: "fa fa-facebook wow fadeIn", "data-wow-delay": "0.3s", target: "blank" })
	                ),
	                React.createElement(
	                  "li",
	                  null,
	                  React.createElement("a", { href: "https://twitter.com", className: "fa fa-twitter wow fadeIn", "data-wow-delay": "0.6s", target: "blank" })
	                ),
	                React.createElement(
	                  "li",
	                  null,
	                  React.createElement("a", { href: "https://youtube.com", className: "fa fa-youtube wow fadeIn", "data-wow-delay": "0.6s", target: "blank" })
	                )
	              )
	            )
	          )
	        ...
	        React.createElement(
	          ...
	          React.createElement("div", { className: "copyright-text wow bounceIn" })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmployerContact = function (_React$Component) {
	  _inherits(EmployerContact, _React$Component);
	
	  function EmployerContact() {
	    _classCallCheck(this, EmployerContact);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EmployerContact).call(this));
	  ...
	  _createClass(EmployerContact, [{
	    key: 'workerChange',
	    value: function workerChange() {
	      this.setState({
	    ...
	    key: 'checkValid',
	    value: function checkValid(value, regexp) {
	    ...
	    value: function sendRegisterRequest() {
	      ...
	      (0, _utils.ajax)('/addUser', this.state.data, function (data) {
	        if (data.success) {
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        'section',
	        { id: 'contact', className: 'parallax-section' },
	        this.state.wait ? React.createElement('img', { src: '/static/images/loading.gif', style: { width: 200 + 'px' } }) : React.createElement(
	          'div',
	          { className: 'container' },
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              'div',
	              { className: 'col-md-6 col-sm-6 wow fadeInDown', 'data-wow-delay': '0.6s', id: 'registrationForm' },
	              React.createElement(
	                'div',
	                { className: 'col-md-12 col-sm-12' },
	                ...
	                React.createElement(
	                  'label',
	                  { htmlFor: 'code', style: { marginRight: 10 + 'px', marginTop: -5 + 'px', color: 'white' } },
	                  'Worker'
	                ),
	                React.createElement('input', { type: 'checkbox', style: { position: 'absolute' }, onClick: this.workerChange.bind(this) }),
	                this.state.worker ? React.createElement('textarea', { className: 'form-control', rows: '3', placeholder: 'Company description', onChange: this.setUserValues.bind(this, 'description') }) : null,
	                this.state.unValid ? React.createElement(
	                  'p',
	                  { className: 'text-danger', style: { padding: 10 + 'px', borderRadius: 5 + 'px', backgroundColor: 'white' } },
	                  !this.state.unValid.error ? this.state.unValid + " is invalid" : this.state.unValid.error
	                ) : null
	              ),
	              React.createElement(
	                'div',
	                ...
	                React.createElement(
	                  'button',
	                  { className: 'form-control', onClick: this.sendRegisterRequest.bind(this) },
	                  'Sign'
	                )
	              )
	            ),
	            React.createElement(
	              'div',
	              { className: 'col-md-6 col-sm-6 wow fadeInUp', 'data-wow-delay': '0.9s' },
	              React.createElement(
	                'div',
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    'p',
	                    null,
	                    '160 New Smooth Road, San Francisco, California'
	                  )
	                ),
	                React.createElement(
	                  'div',
	                  ...
	                  React.createElement(
	                    'p',
	                    null,
	                    'Email: workemployer@gmail.com'
	                  ),
	                  React.createElement(
	                    'p',
	                    null,
	                    'Tel: 010-020-0770     Fax: 090-080-0430'
	                  )
	                )
	              )
	            )
	...
	exports.default = EmployerContact;
	module.exports = exports['default'];
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(147)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainContent = function (_React$Component) {
	  ...
	  function MainContent() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MainContent).call(this));
	  ...
	  _createClass(MainContent, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        'div',
	        null,
	        React.createElement(_components.Home, null),
	        React.createElement(_components.Description, null),
	        React.createElement(_components.Counter, { employers: this.state.employers, developers: this.state.developers }),
	        React.createElement(_components.MainTips, { tips: this.state.tips }),
	        React.createElement(_components.EmployerContact, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainTip = function (_React$Component) {
	  _inherits(MainTip, _React$Component);
	
	  function MainTip() {
	    _classCallCheck(this, MainTip);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(MainTip).apply(this, arguments));
	  }
	
	  _createClass(MainTip, [{
	    key: "render",
	    value: function render() {
	      return React.createElement(
	        "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainTips = function (_React$Component) {
	  _inherits(MainTips, _React$Component);
	
	  function MainTips() {
	    _classCallCheck(this, MainTips);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(MainTips).apply(this, arguments));
	  }
	
	  _createClass(MainTips, [{
	    key: "generateTips",
	    value: function generateTips() {
	      return this.props.tips.map(function (tip, key) {
	        return React.createElement(_components.MainTip, {
	          title: tip.title,
	          img: tip.img,
	          date: tip.date,
	          text: tip.text,
	    ...
	    value: function render() {
	      return React.createElement(
	        "section",
	        { id: "blog", className: "paralla-section" },
	        React.createElement(
	          "div",
	          { className: "container" },
	          React.createElement(
	            ...
	            React.createElement(
	              "div",
	              { className: "blog-masonry masonry-true" },
	              this.generateTips()
	            )
	          )
	        )
	...
	var Counter = function (_React$Component) {
	  ...
	  _createClass(Counter, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "section",
	        { id: "counter", className: "paralla-section" },
	        React.createElement(
	          "div",
	          { className: "container" },
	          React.createElement(
	            "div",
	            { className: "row", id: "counterContainer" },
	            React.createElement(
	              "div",
	              { className: "col-md-3 col-sm-3 counter-item" },
	              React.createElement(
	                "h3",
	                { className: "counter-number", "data-from": "1", "data-to": "256", "data-speed": "1000" },
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                "h3",
	                { className: "counter-number", "data-from": "1", "data-to": "512", "data-speed": "2000" },
	...
	var Home = function (_React$Component) {
	  ...
	  _createClass(Home, [{
	    ...
	    value: function signUp() {
	      (0, _utils.scrollToElement)('contact');
	    }
	  }, {
	    key: 'signIn',
	    ...
	    value: function render() {
	      return React.createElement(
	        'div',
	        null,
	        this.state.signFormOpen ? React.createElement(_components.SignInForm, null) : null,
	        React.createElement(
	          'section',
	          { id: 'home', className: 'parallax-section' },
	          React.createElement(
	            'div',
	            { className: 'container' },
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  'h3',
	                  { className: 'wow fadeInDown', 'data-wow-delay': '0.2s' },
	                  'FIND WORK IS SO EASY!'
	                ),
	                React.createElement(
	                  'h1',
	                ...
	                React.createElement(
	                  'a',
	                  { href: '#', className: 'btn btn-danger wow fadeInUp', 'data-wow-delay': '0.3s', onClick: this.signUp.bind(this) },
	                  'SIGN UP'
	                ),
	                React.createElement(
	                  'a',
	                  { to: '/feachures', className: 'btn btn-default smoothScroll wow fadeInUp', onClick: this.signIn.bind(this) },
	                  'SIGN IN'
	                )
	              )
	            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserMain = function (_React$Component) {
	  _inherits(UserMain, _React$Component);
	
	  function UserMain() {
	    _classCallCheck(this, UserMain);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(UserMain).call(this));
	
	    _this.changeEdit = function (resumeId) {
	      _this.setState({
	  ...
	  _createClass(UserMain, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      (0, _utils.ajax)('/getUserInfo', { id: window.localStorage['id'] }, function (data) {
	        _this2.setState({
	    ...
	    value: function generateResumes() {
	      ...
	      return this.state.resumes.map(function (resume, key) {
	        var _React$createElement;
	
	        return React.createElement(_components.UserMainResume, (_React$createElement = {
	          post: resume.post,
	          key: key,
	          id: resume.id,
	          userId: resume.userId
	        }, _defineProperty(_React$createElement, 'post', resume.post), _defineProperty(_React$createElement, 'updateComponent', _this4.updateComponent.bind(_this4)), _defineProperty(_React$createElement, 'changeEdit', _this4.changeEdit), _React$createElement));
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return this.state.edit ? React.createElement(_components.CreateResume, { edit: true, changeEdit: this.changeEdit, resumeId: this.state.resumeId }) : this.state.username ? React.createElement(
	        'div',
	        { className: 'post-masonry col-md-4 col-sm-6 wow fadeInUp', style: { width: 90 + '%', margin: 50 + 'px', marginTop: 100 + 'px', color: 'gray' } },
	        React.createElement(
	          'section',
	          { className: 'userHeader' },
	          React.createElement(
	            'span',
	            { style: { fontSize: 25 + 'pt' } },
	            'Hello ',
	            this.state.username
	          ),
	          ...
	          React.createElement(
	            _reactRouter.Link,
	            { to: '/createResume', className: 'btn btn-default', style: { marginLeft: 50 + 'px' } },
	            'Create resume'
	          ),
	        ...
	        React.createElement(
	          'section',
	          { className: 'userResumes' },
	          this.state.resumes && this.state.resumes.length !== 0 ? this.generateResumes() : this.state.resumes.length == 0 ? React.createElement(
	            'div',
	            null,
	            'Do not have resumes'
	...
	var Description = function (_React$Component) {
	  ...
	  _createClass(Description, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "section",
	        { id: "about", className: "paralla-section" },
	        React.createElement(
	          "div",
	          { className: "container" },
	          React.createElement(
	            _components.DescriptionItem,
	            { left: true },
	            React.createElement(
	              "h4",
	              null,
	              "The most friendly service for you"
	            ),
	            React.createElement(
	              "h3",
	              null,
	            ...
	            React.createElement(
	              "p",
	              null,
	              "You have much fun with us! Finding work, will be easy, and similar to game. You must only create account, write your resume and wait for thousand sentences."
	            )
	          ),
	          React.createElement(
	            _components.DescriptionItem,
	            ...
	            React.createElement(
	              "h4",
	              null,
	              "The best search in all professions"
	            ),
	            React.createElement(
	              "h3",
	              null,
	              "Employers come to us and find your best workers!"
	            ),
	            React.createElement(
	              "p",
	              null,
	              "If you are employer and you need find workers, this service is the best of you can find."
	            )
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DescriptionItem = function (_React$Component) {
	  ...
	  function DescriptionItem() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(DescriptionItem).apply(this, arguments));
	  }
	  ...
	  _createClass(DescriptionItem, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        { className: "row" },
	        this.props.left ? React.createElement(
	          "div",
	          { className: "col-md-6 col-sm-12" },
	          React.createElement("img", { src: "/static/images/mobile-worker-1.jpg", className: "img-responsive", alt: "about img 1" })
	        ) : null,
	        React.createElement(
	          "div",
	          { className: "col-md-6 col-sm-12" },
	        ...
	        !this.props.left ? React.createElement(
	          "div",
	          { className: "col-md-6 col-sm-12" },
	          React.createElement("img", { src: "/static/images/Office-Worker-Girl.jpg", className: "img-responsive", alt: "about img 1" })
	        ) : null
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Resumes = function (_React$Component) {
	  _inherits(Resumes, _React$Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Feachures = function (_React$Component) {
	  _inherits(Feachures, _React$Component);
	
	  function Feachures() {
	    _classCallCheck(this, Feachures);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Feachures).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tip = function (_React$Component) {
	  ...
	  function Tip() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Tip).call(this));
	  ...
	  _createClass(Tip, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        'div',
	        { onClick: this.openTip.bind(this), className: 'post-masonry col-md-4 col-sm-6 wow fadeInUp', style: { cursor: 'pointer', width: 100 + '%', marginBottom: 15 + 'px' } },
	        React.createElement('img', { src: this.props.img, className: 'tipImage', alt: 'blog img' }),
	        React.createElement(
	          'h3',
	        ...
	        React.createElement(
	          'p',
	          null,
	          this.state.openTip ? this.props.text : this.props.text.slice(0, 1000)
	        )
	      );
	    }
	  }]);
	  ...
	  _createClass(Loader, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        { className: "loader" },
	        React.createElement("img", { src: "/static/images/loading.gif", style: { width: 200 + 'px' } })
	      );
	    }
	  }]);
	...
	var Sidebar = function (_React$Component) {
	  ...
	  _createClass(Sidebar, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "nav",
	        { className: "navbar navbar-default sidebar", role: "navigation" },
	        React.createElement(
	          "div",
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              "button",
	              { type: "button", className: "navbar-toggle", "data-target": "#bs-sidebar-navbar-collapse-1" },
	              React.createElement(
	                "span",
	                { className: "sr-only" },
	                "Toggle navigation"
	          ...
	          React.createElement(
	            "div",
	            { className: "collapse navbar-collapse", id: "bs-sidebar-navbar-collapse-1" },
	            React.createElement(
	              "ul",
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  { href: "#" },
	                  "Home",
	                  React.createElement("span", { style: { fontSize: 16 + 'px' }, className: "pull-right hidden-xs showopacity glyphicon glyphicon-home" })
	                )
	              ),
	              React.createElement(
	                "li",
	                ...
	                React.createElement(
	                  ...
	                  React.createElement("span", { style: { fontSize: 16 + 'px' }, className: "pull-right hidden-xs showopacity glyphicon glyphicon-user" })
	                ),
	                React.createElement(
	                  "ul",
	                  { className: "dropdown-menu forAnimate", role: "menu" },
	                  React.createElement(
	                    "li",
	                    null,
	                    React.createElement(
	                      "a",
	                      { href: "{{URL::to('createusuario')}}" },
	                      "Crear"
	                    )
	                  ),
	                  React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  { href: "#" },
	                  "Libros",
	                  React.createElement("span", { style: { fontSize: 16 + 'px' }, className: "pull-right hidden-xs showopacity glyphicon glyphicon-th-list" })
	                )
	              ),
	              React.createElement(
	                "li",
	                ...
	                React.createElement(
	                  ...
	                  { href: "#" },
	                  "Tags",
	                  React.createElement("span", { style: { fontSize: 16 + 'px' }, className: "pull-right hidden-xs showopacity glyphicon glyphicon-tags" })
	                )
	              )
	            )
	          )
	...
	var SignInForm = function (_React$Component) {
	  ...
	  _createClass(SignInForm, [{
	    ...
	    value: function sendRegisterRequest() {
	      ...
	      (0, _utils.ajax)('/login', this.state.data, function (data) {
	        if (data.success) {
	          window.localStorage.setItem('id', data.userId);
	          if (parseInt(data.worker)) {
	            window.location.href = '/worker/';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreateResume = function (_React$Component) {
	  _inherits(CreateResume, _React$Component);
	
	  function CreateResume() {
	    _classCallCheck(this, CreateResume);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CreateResume).call(this));
	  ...
	  _createClass(CreateResume, [{
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	      var _this2 = this;
	
	      if (this.props.edit) {
	        (0, _utils.ajax)('/getResume', { id: this.props.resumeId, userId: window.localStorage['id'] }, function (data) {
	          _this2.setState({
	            data: {
	              name: data.name,
	              email: data.email,
	    ...
	    value: function sendResume() {
	      if (this.props.edit) {
	        (0, _utils.ajax)('/editResume', { resumeId: this.props.resumeId, data: this.state.data });
	        this.props.changeEdit();
	      } else {
	        (0, _utils.ajax)('/addResume', this.state.data);
	      }
	    }
	  }, {
	    key: 'addSkill',
	    value: function addSkill() {
	      this.state.data.skills = [].concat(_toConsumableArray(this.state.data.skills), [{
	    ...
	    key: 'deleteSkill',
	    value: function deleteSkill(key) {
	    ...
	    key: 'deleteCompany',
	    value: function deleteCompany(key) {
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement('input', { className: 'form-control', id: 'name', placeholder: 'name', onChange: this.setUserValues.bind(this, 'name'), value: this.state.data.name })
	        ),
	        React.createElement(
	          'div',
	          { className: 'form-group' },
	          React.createElement(
	            'label',
	            { htmlFor: 'post', className: 'col-sm-2 control-label' },
	            'Post'
	          ),
	          React.createElement('input', { className: 'form-control', id: 'post', placeholder: 'Post', onChange: this.setUserValues.bind(this, 'post'), value: this.state.data.post })
	        ),
	        React.createElement(
	          'div',
	          { className: 'form-group' },
	          ...
	          React.createElement('input', { type: 'email', className: 'form-control', id: 'email', placeholder: 'Email', onChange: this.setUserValues.bind(this, 'email'), value: this.state.data.email })
	        ),
	        React.createElement(
	          'div',
	          { className: 'form-group' },
	          React.createElement(
	            'label',
	            { htmlFor: 'city', className: 'col-sm-2 control-label' },
	            'City'
	          ),
	          React.createElement('input', { className: 'form-control', id: 'city', placeholder: 'City', onChange: this.setUserValues.bind(this, 'city'), value: this.state.data.city })
	        ),
	        React.createElement(
	          'div',
	          { className: 'form-group' },
	          ...
	          React.createElement('input', { className: 'form-control', id: 'phone', placeholder: 'Phone', onChange: this.setUserValues.bind(this, 'phone'), value: this.state.data.phone })
	        ),
	        React.createElement(
	          'div',
	          { className: 'form-group' },
	          React.createElement(
	            'label',
	            { htmlFor: 'about', className: 'col-sm-2 control-label' },
	            'About'
	          ),
	          React.createElement('textarea', { className: 'form-control', id: 'about', rows: '3', onChange: this.setUserValues.bind(this, 'about'), value: this.state.data.about })
	        ),
	        React.createElement('hr', null),
	        this.state.data.skills && this.state.data.skills.length > 0 ? this.state.data.skills.map(function (skill, key) {
	          return React.createElement(
	            'div',
	            { key: key, style: { display: 'inline-block', marginRight: 15 + 'px', marginBottom: 15 + 'px' } },
	            React.createElement('br', null),
	            React.createElement(
	              'span',
	            ...
	            React.createElement(
	              'button',
	              { className: 'btn btn-default', onClick: _this3.deleteSkill.bind(_this3, key) },
	              'Delete skill'
	            )
	          );
	        }) : null,
	        ...
	        React.createElement(
	          ...
	          React.createElement('input', { className: 'form-control', id: 'skill', placeholder: 'Skill', value: this.state.data.currentSkill, onChange: this.setUserValues.bind(this, 'currentSkill') }),
	          React.createElement('br', null),
	          React.createElement(
	            'label',
	          ...
	          React.createElement('textarea', { className: 'form-control', rows: '3', value: this.state.data.currentDescription, onChange: this.setUserValues.bind(this, 'currentDescription') })
	        ),
	        React.createElement(
	          'button',
	          { type: 'submit', className: 'btn btn-default', onClick: this.addSkill.bind(this) },
	          'Add skill'
	        ),
	        React.createElement('hr', null),
	        this.state.data.companies && this.state.data.companies.length > 0 ? this.state.data.companies.map(function (company, key) {
	          return React.createElement(
	            'div',
	            { key: key, style: { display: 'inline-block', marginRight: 15 + 'px', marginBottom: 15 + 'px' } },
	            React.createElement('br', null),
	            ...
	            React.createElement(
	              'button',
	              { className: 'btn btn-default', onClick: _this3.deleteCompany.bind(_this3, key) },
	              'Delete company'
	            )
	          );
	        }) : null,
	        ...
	        React.createElement(
	          ...
	          React.createElement('textarea', { className: 'form-control', rows: '3', value: this.state.data.currentExpirience, onChange: this.setUserValues.bind(this, 'currentExpirience') })
	        ),
	        React.createElement(
	          'button',
	          { type: 'submit', className: 'btn btn-default', onClick: this.addCompany.bind(this) },
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              _reactRouter.Link,
	              { to: '/user/', className: 'btn btn-default', onClick: this.sendResume.bind(this), style: { marginTop: 10 + 'px' } },
	              this.props.edit ? "Edit complete" : "Add resume"
	            )
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserMainResume = function (_React$Component) {
	  _inherits(UserMainResume, _React$Component);
	
	  function UserMainResume() {
	    _classCallCheck(this, UserMainResume);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(UserMainResume).call(this));
	  ...
	  _createClass(UserMainResume, [{
	    ...
	    key: 'deleteResume',
	    value: function deleteResume(e) {
	      var _this2 = this;
	
	      e.stopPropagation();
	      (0, _utils.ajax)('/deleteResume', { id: this.props.id, post: this.props.post, userId: this.props.userId }, function (data) {
	        _this2.props.updateComponent();
	      });
	    }
	  }, {
	    key: 'openResume',
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          _reactRouter.Link,
	          { to: '/resume', onClick: this.openResume.bind(this) },
	          React.createElement(
	            'span',
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            { type: 'button', className: 'btn btn-default', onClick: function onClick() {
	                return _this3.props.changeEdit(_this3.props.id);
	              } },
	            'Change'
	          ),
	          React.createElement(
	            'button',
	            { type: 'button', onClick: this.deleteResume.bind(this), className: 'btn btn-default', style: { marginLeft: 5 + 'px' } },
	            'Delete'
	          )
	        ),
	        React.createElement('hr', null)
	  ...
	  return UserMainResume;
	}(React.Component);
	
	exports.default = UserMainResume;
	module.exports = exports['default'];
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(147)))
